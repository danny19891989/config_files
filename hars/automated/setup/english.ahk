...
F12 & sc003::send {Media_Next}
F12 & sc029::send {Media_Prev}
F12 & sc002::send {Media_Play_Pause}
F12 & sc004::send {Volume_Mute}
F12 & sc005::send {Volume_Down}
F12 & sc006::send {Volume_Up}

F12 & sc020::SendInput #d
F12 & sc01e::SendInput #a
F12 & sc012::SendInput #e
F12 & sc013::#r
...
;Control Panel
F12 & sc02c:: run ::{21ec2020-3aea-1069-a2dd-08002b30309d}
return

;task manager
F12 & sc02d:: run, c:\windows\system32\taskmgr.exe
return
...
sc033 & sc012::selectHome()
sc033 & sc02D::selectEnd()
...
LShift & sc043::send {Blind} {AppsKey}
